<div class="row">
 	<div class="medium-12 columns">
			...
			<ul class="lista-de-modulos small-block-grid-1 medium-block-grid-3">
																	...
																	<?php // Se estiver clicado em listado na pagina inicial
																			if( get_sub_field('acf_block_module__list_module__dastaque') == TRUE ) {  ?>
																				...
																				<li class="lista-de-modulos__item">
																						...
																						<!--   inicia modal -->
																							<div id="modal-modulos-<?php echo $id; ?>" class="reveal-modal medium" data-reveal aria-labelledby="videoModalTitle" aria-hidden="true" role="dialog">
			...
			<div class="small-12 columns">
 					...
 					<?php if (get_sub_field('acf_block_module__list_modules_show_all') == FALSE ) {  ?>
					 <!-- false  -->
					<?php  } else {  ?>
					<a href="#" class="link-open-modal" data-reveal-id="modal-modulos-todos" >Veja todos os Módulos <i class="material-icons md-18">&#xE89E;</i></a>
					<?php  } ?>
